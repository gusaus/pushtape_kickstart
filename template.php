 ...
 * @see html.tpl.php
 */
function pushtape_kickstart_preprocess_html(&$variables) {
  // Add conditional stylesheets for IE
  $theme_path = drupal_get_path('theme', 'pushtape_kickstart');
 ...
 */
function pushtape_kickstart_css_alter(&$css) {
  global $language;
 ...
 * Preprocess field.
 */
function pushtape_kickstart_preprocess_field(&$variables) {
 ...
 */
function pushtape_kickstart_preprocess_node(&$variables) {
